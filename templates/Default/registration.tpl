...
<div class="baseform">
	...
	[registration]
		<tr>
			...
			<td>
				<input type="text" name="name" id='name' style="width:175px; margin-right: 6px;" class="f_input" /><input class="btn" style="font-size: 11px;" title="Проверить доступность логина для регистрации" onclick="CheckLogin(); return false;" type="button" value="Проверить имя" />
	...
	[validation]
		...
		<tr>
			...
			<td><input type="file" name="image" style="width:304px;" class="f_input" /></td>
		</tr>
		<tr>
