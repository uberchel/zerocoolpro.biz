	...
	<div class="baseform">
		<table class="tableform">
			...
			<tr>
				...
				<td>Загрузить с компьютера: <input type="file" name="image" class="f_input" />
				
				<br /><br /><div class="checkbox" style="display: flex;"><input type="checkbox" name="del_foto" id="del_foto" value="yes" /> <label for="del_foto">Удалить аватар</label></div>
				</td>
			</tr>
			<tr>
