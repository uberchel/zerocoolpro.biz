...
class XenForo_Importer_IPBoard40x extends XenForo_Importer_IPBoard34x
{
	...
	{
		$appCache = array_combine($adminRestrictions['applications'], $adminRestrictions['applications']);

		if (!array_key_exists($appName, $appCache))
		{
			return false;
		}
		...
		if (isset($moduleName))
		{
			$moduleCache = array_combine($adminRestrictions['modules'], $adminRestrictions['modules']);
