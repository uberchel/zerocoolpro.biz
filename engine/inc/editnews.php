...
HTML;
	...
	$(function(){
		...
		$('#tags').tagsInput({
				width: '400px',
				autocomplete_url:'engine/ajax/find_tags.php',
				autocomplete:{minLength: 3, delay: 500},
				'defaultText':''
		});

		$('[data-rel=links]').tagsInput({
	      width: '437px',
		  'defaultText':''
		});
...
{$output}
							...
							<div class="form-group">
							  ...
							  <div class="col-lg-10">
								<input class="icheck" type="checkbox" id="view_edit" name="view_edit" value="1" {$view_edit_cheked}><label for="view_edit">{$lang['allow_view_edit']}</label><br /><input type="text" size="55" name="editreason" id="editreason" value="{$row['reason']}"> {$lang['news_edit_date']}
							  </div>
							 </div>
                    ...
                    <div class="tab-pane" id="tabextra" >
						<div class="row box-section">
							...
							<div class="form-group">
							  ...
							  <div class="col-lg-10">
								<input type="text" name="alt_name" style="width:100%;max-width:400px;" value="{$row['alt_name']}">&nbsp;<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['hint_url']}" >?</span>
							  </div>
							 </div>
							<div class="form-group">
							  <label class="control-label col-lg-2">{$lang['addnews_tags']}</label>
							  <div class="col-lg-10">
								<input type="text" name="tags" id="tags" style="width:100%;max-width:400px;" autocomplete="off" value="{$row['tags']}" />
							  </div>
							 </div>
							<div class="form-group">
							...
							<div class="form-group">
							  ...
							  <div class="col-lg-10">
								<textarea class="tags" name="keywords" id='keywords' style="width:100%;max-width:413px;height:70px;">{$row['keywords']}</textarea><br />
