                    ...
                    <div class="tab-pane" id="tabextra" >
						<div class="row box-section">
							...
							<div class="form-group">
							  ...
							  <div class="col-lg-10">
								<input type="text" name="alt_name" style="width:100%;max-width:400px;">&nbsp;<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['hint_url']}" >?</span>
							  </div>
							 </div>
							<div class="form-group">
							  <label class="control-label col-lg-2">{$lang['addnews_tags']}</label>
							  <div class="col-lg-10">
								<input type="text" name="tags" id="tags" style="width:100%;max-width:400px;" autocomplete="off" />
							  </div>
							 </div>	
							<div class="form-group">
							...
							<div class="form-group">
							  ...
							  <div class="col-lg-10">
								<textarea class="tags" name="keywords" id='keywords' style="width:100%;max-width:413px;height:70px;"></textarea><br />
