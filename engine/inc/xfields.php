...
echo <<<HTML
		<div class="form-group">
		  ...
		  <div class="col-lg-10">
			<select name="editedxfield[2][]" id="category" style="width:100%;max-width: 350px;height:100px;" multiple><option value="" {$cats_value}>{$lang['xfield_xall']}</option>{$cat_options}</select>
		  </div>
		 </div>	
HTML;
