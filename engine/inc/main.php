...
<div class="box">
  ...
  <div class="box-content">
	...
	<div class="row box-section">	
	  ...
	  <div class="col-md-6">
		<div class="news with-icons">
		  <div class="avatar"><img src="engine/skins/images/ads.png"></div>
		  <div class="news-content">
...
HTML;
	...
	if (!$test) {
		echo "<div class=\"alert alert-error\">{$lang['stat_iconv']}</div>";
	}
