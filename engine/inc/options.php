...
<div class="box">
  ...
  <div class="box-content">
	...
	<div class="row box-section">
		...
		<div class="form-group">
		  <label class="col-lg-2">{$lang['opt_icq']}</label>
		  <div class="col-lg-10">
			<input style="width:100%;max-width:350px;" type="text" name="editicq" value="{$member_id['icq']}">
		  </div>
		 </div>
		<div class="form-group">
...
<div class="action-nav-normal action-nav-line">
  ...
  <div class="row action-nav-row">
    <div class="col-sm-1 action-nav-button" style="min-width:90px;">
      <a href="javascript:ChangeOption('general');" class="tip" title="{$lang['opt_allsys']}">
        <i class="icon-cog"></i>
    ...
    <div class="col-sm-1 action-nav-button">
      <a href="javascript:ChangeOption('security');" class="tip" title="{$lang['opt_secrsys']}">
        <i class="icon-umbrella"></i>
        <span>{$lang['opt_b_2']}</span>
      </a>
    </div>

    <div class="col-sm-1 action-nav-button">
      <a href="javascript:ChangeOption('news');" class="tip" title="{$lang['opt_newssys']}">
        <i class="icon-file-alt"></i>
        <span>{$lang['opt_b_3']}</span>
      </a>
    </div>

    <div class="col-sm-1 action-nav-button">
      <a href="javascript:ChangeOption('comments');" class="tip" title="{$lang['opt_commsys']}">
        <i class="icon-pencil"></i>
        <span>{$lang['opt_b_4']}</span>
      </a>
    </div>
    <div class="col-sm-1 action-nav-button">
      <a href="javascript:ChangeOption('optimisation');" class="tip" title="{$lang['opt_dbsys']}">
        <i class="icon-bar-chart"></i>
        <span>{$lang['opt_b_5']}</span>
      </a>
    </div>
    <div class="col-sm-1 action-nav-button">
      <a href="javascript:ChangeOption('files');" class="tip" title="{$lang['opt_filesys']}">
        <i class="icon-upload-alt"></i>
        <span>{$lang['opt_b_6']}</span>
      </a>
    </div>
    <div class="col-sm-1 action-nav-button">
      <a href="javascript:ChangeOption('mail');" class="tip" title="{$lang['opt_sys_mail']}">
        <i class="icon-envelope"></i>
        <span>{$lang['opt_b_7']}</span>
      </a>
    </div>
    <div class="col-sm-1 action-nav-button">
      <a href="javascript:ChangeOption('users');" class="tip" title="{$lang['opt_usersys']}">
        <i class="icon-user"></i>
        <span>{$lang['opt_b_8']}</span>
      </a>
    </div>
    <div class="col-sm-1 action-nav-button">
      <a href="javascript:ChangeOption('imagesconf');" class="tip" title="{$lang['opt_imagesys']}">
        <i class="icon-picture"></i>
        <span>{$lang['opt_b_9']}</span>
      </a>
    </div>
    <div class="col-sm-1 action-nav-button">
      <a href="javascript:ChangeOption('smartphone');" class="tip" title="{$lang['opt_smartphone']}">
        <i class="icon-mobile-phone"></i>
        <span>{$lang['opt_b_10']}</span>
      </a>
    </div>
    <div class="col-sm-1 action-nav-button">
      <a href="javascript:ChangeOption('rss');" class="tip" title="{$lang['opt_rsssys']}">
        <i class="icon-rss"></i>
        <span>RSS</span>
      </a>
    </div>
...
HTML;
	...
	showRow( $lang['opt_sys_ht'], $lang['opt_sys_htd'], "<input type=text style=\"width:100%;\" name=\"save_con[home_title]\" value=\"{$config['home_title']}\">" );
	...
	showRow( $lang['opt_sys_at'], $lang['opt_sys_atd']." ".date ( "d.m.Y, H:i", time () + ($config['date_adjust'] * 60) ), "<input  type=text style=\"text-align: center;\"  name=\"save_con[date_adjust]\" value=\"{$config['date_adjust']}\" size=20>" );
...
HTML;
	...
	showRow( $lang['opt_sys_path'], $lang['opt_sys_pathd'], "<input type=\"text\" name=\"save_con[admin_path]\" value=\"{$config['admin_path']}\" size=50>" );
...
HTML;
	...
	showRow( $lang['opt_sys_newc'], $lang['opt_sys_newd'], "<input type=text style=\"text-align: center;\"  name=\"save_con[news_number]\" value=\"{$config['news_number']}\" size=20>" );
...
HTML;
	...
	showRow( $lang['opt_sys_amail'], $lang['opt_sys_amaild'], "<input  type=text name='save_con[admin_mail]' value='{$config['admin_mail']}' size=40>" );
...
HTML;
	...
	showRow( $lang['opt_sys_maxside'], $lang['opt_sys_maxsided'], "<input  type=text style=\"text-align: center;\"  name='save_con[max_up_side]' value=\"{$config['max_up_side']}\" size=20>" );
