...
<table class="table table-normal table-hover settingsgr">
    <tr>
        <td class="col-xs-10 col-sm-6 col-md-7"><h6>{$lang['group_name']}</h6><span class="note large">{$lang[hint_gtitle]}</span></td>
        <td class="col-xs-2 col-md-5"><input type="text" style="width:100%;" name="group_name" value="{$group_name_value}"></td>
    </tr>
...
<table class="table table-normal table-hover settingsgr">
    <tr>
        <td class="col-xs-10 col-sm-6 col-md-7"><h6>{$lang['group_ct']}</h6><span class="note large">{$lang['hint_gacats']}</span></td>
        <td class="col-xs-2 col-md-5"><select data-placeholder="{$lang['addnews_cat_sel']}" name="allow_cats[]" style="width:350px;" class="cat_select" multiple >
...
<table class="table table-normal table-hover settingsgr">
    <tr>
        <td class="col-xs-10 col-sm-6 col-md-7"><h6>{$lang['group_addc']}</h6><span class="note large">{$lang['hint_gac']}</span></td>
        <td class="col-xs-2 col-md-5"><input class="iButton-icons-tab" type="checkbox" name="allow_addc" {$allow_addc} value="1"></td>
    </tr>
...
<table class="table table-normal table-hover settingsgr">
     <tr>
        <td class="col-xs-10 col-sm-6 col-md-7"><h6>{$lang['opt_sys_news_c']}</h6><span class="note large">{$lang['hint_scode']}</span></td>
        <td class="col-xs-2 col-md-5"><input class="iButton-icons-tab" type="checkbox" name="news_sec_code" {$news_sec_code} value="1" {$gastgroup}></td>
    </tr>
...
<table class="table table-normal table-hover settingsgr">
    <tr>
        <td class="col-xs-10 col-sm-6 col-md-7"><h6>{$lang['group_aadm']}</h6><span class="note large">{$lang['hint_gadmin']}</span></td>
        <td class="col-xs-2 col-md-5"><input class="iButton-icons-tab" type="checkbox" name="allow_admin" {$allow_admin} value="1" {$gastgroup}{$admingroup}></td>
    </tr>
