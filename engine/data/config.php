...
'home_title' => 'Кнопка бабло ZerocooLPro.biz - Как заработать в интернете',

'http_home_url' => 'http://kinotraffic.com/',

'charset' => 'windows-1251',

'description' => 'zerocoolpro.biz - Сайт о заработке в интернете. Я расскажу Вам как я заработал свой первый миллион в интернете и как зарабатываю сейчас!',

'keywords' => 'Заработать в интернете, zerocoolpro.biz, кнопка бабло, заработок на киносайтах, заработок на сайте',

'short_title' => 'ZerocooLPro.biz',
...
'admin_mail' => 'ftpzerocool@mail.ru',
