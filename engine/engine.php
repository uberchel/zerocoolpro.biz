...
if ($config['speedbar'] and ! isset ( $view_template )) {
	...
	elseif ($do == 'tags') {
		...
		if ($config['allow_alt_url']) $s_navigation .= " &raquo; <span itemscope itemtype=\"http://data-vocabulary.org/Breadcrumb\"><a href=\"" . $config['http_home_url'] . "tags/\" itemprop=\"url\"><span itemprop=\"title\">" . $lang['tag_cloud'] . "</span></a></span> &raquo; " . $tag;
